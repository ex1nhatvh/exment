...
return [
    ...
    'operation_log' => [
        ...
        'ip' => 'IPアドレス',
        'input' => '入力・クエリ',
        'enable_automatic' => '操作ログ自動削除',
        'keep_days' => 'ログ保存期間（日数）',
        'keep_days_help' => '指定した日数より古い操作ログを自動的に削除します。1以上の値を入力してください。',
        'schedule_all' => 'すべて',
        'automatic_week' => '実行曜日',
        'automatic_month' => '実行月',
        'automatic_day' => '実行日',
        'automatic_hour' => '実行時間（時）',
        'automatic_minute' => '実行時間（分）',
        'automatic_week_help' => '未選択の場合、曜日を問わず実行します。',
        'automatic_month_help' => '未選択の場合、月を問わず実行します。',
        'automatic_day_help' => '未選択の場合、日に関係なく実行します。曜日と日を両方指定した場合は、両方の条件を満たす日時に実行します。',
