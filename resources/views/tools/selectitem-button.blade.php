...
<a href="{{$model->getUrl()}}" target="_blank" rel="noopener" class="btn btn-default btn-xs" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ exmtrans('common.open_blank') }}">
